...
import useKakaoSearchHook from '@/hooks/flagset/searchplaceHook';
  ...
  return (
    <ModalOverlay>
      <div style={{ padding: '20px' }}>
        <SearchTop>
          <div onClick={onClose}>
            <img src="/images/common/back.png" style={{ width: '30px' }} />
          </div>
          <TopTitle> 주소 검색</TopTitle>
        </SearchTop>
        <SearchBar>
          <img src="/images/map/search.png" style={{ width: '30px' }} />
          ...
          {query.length > 0 && (
            <button onClick={() => setQuery('')} style={{ border: 'none' }}>
              <img src="/images/map/erase.png" style={{ width: '25px' }} />
            </button>
          )}
        </SearchBar>
      </div>
