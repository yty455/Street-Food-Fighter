...
public interface ReviewRepository extends JpaRepository<Review, Long> {
    ...
    @Query("select new com.sff.storeserver.domain.review.dto.StoreReviewResponse(r.createdDate, r.score, r.content, r.userId, r.orderId) from Review r where r.store.id = :storeId")
